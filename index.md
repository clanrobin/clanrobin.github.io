...
For each chapter, I've included the R code and my attempts at the questions. For the early chapters I've converted the original .R code to .Rmd for ease of viewing.
